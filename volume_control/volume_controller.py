...
class hand:
    ...
    def pinch_separation(self):
        ...
        thumb_index_separation = math.hypot(
            self.index_x - self.thumb_x, self.index_y - self.thumb_y
        )
    ...
    def screen_separation(self):
        ...
        closest_distance = math.hypot(
            self.index_below_x - self.index_x, self.index_below_y - self.index_y
        )
    ...
    if results.multi_hand_landmarks:
        ...
        for handLms in results.multi_hand_landmarks:
            for ids, lm in enumerate(handLms.landmark):
                ...
                cv2.line(
                    img,
                    (mano.index_x, mano.index_y),
                    (mano.thumb_x, mano.thumb_y),
                    (255, 0, 0),
                    5,
                )
